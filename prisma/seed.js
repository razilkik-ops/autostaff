...
const products = [
  { slug: "drying-towel", category: "mikrofibra", name: "Сушащее полотенце G1500", shortName: "Полотенце G1500", sku: "SGCB-TWL-1500", price: 4990, image: "/assets/drying-towel.png", images: ["/assets/drying-towel.png", "/assets/promo-detailing.png", "/assets/sgcb-tools-banner-ru.jpg"], stock: 24, description: "Двустороннее микрофибровое полотенце быстро впитывает воду и не оставляет разводов на кузове.", specs: [["Размер", "60 × 90 см"], ["Плотность", "1500 г/м²"], ["Материал", "Микрофибра"], ["Цвет", "Графит"]] },
  { slug: "detailing-bucket", category: "oborudovanie", name: "Ведро для мойки Detailing Lab 20L", shortName: "Ведро Detailing Lab 20L", sku: "SGCB-BKT-20", price: 2990, image: "/assets/detailing-bucket.png", images: ["/assets/detailing-bucket.png", "/assets/promo-detailing.png", "/assets/sgcb-tools-banner-ru.jpg"], stock: 18, description: "Прочное ведро с герметичной крышкой для безопасной и удобной ручной мойки автомобиля.", specs: [["Объём", "20 л"], ["Материал", "HDPE-пластик"], ["Крышка", "Герметичная"], ["Цвет", "Синий"]] },
  ...
  { slug: "polishing-machine", category: "polirovalnye-mashinki", name: "Полировальная машинка DA15", shortName: "Полировальная машинка DA15", sku: "SGCB-DA15", price: 24990, image: "/assets/polishing-machine.png", images: ["/assets/polishing-machine.png", "/assets/sgcb-tools-banner-ru.jpg", "/assets/hero-auto.png"], stock: 7, description: "Эксцентриковая полировальная машинка для безопасной коррекции лака и профессиональной работы в детейлинг-центре.", specs: [["Ход эксцентрика", "15 мм"], ["Мощность", "1000 Вт"], ["Подложка", "125 мм"], ["Гарантия", "12 месяцев"]] },
  { slug: "interior-brushes", category: "interer", name: "Набор кистей для интерьера", shortName: "Кисти для интерьера", sku: "SGCB-BRUSH-5", price: 3490, image: "/assets/interior-brushes.png", images: ["/assets/interior-brushes.png", "/assets/sgcb-tools-banner-ru.jpg", "/assets/promo-detailing.png"], stock: 32, description: "Пять мягких кистей разных размеров для безопасной очистки дефлекторов, кнопок, швов и других сложных зон салона.", specs: [["Количество", "5 шт."], ["Материал ворса", "Синтетика"], ["Рукоять", "Пластик"], ["Назначение", "Интерьер"]] },
  { slug: "ppf-film", category: "ppf", name: "Защитная плёнка PPF Clear Pro", shortName: "Плёнка PPF Clear Pro", sku: "SGCB-PPF-15", price: 89900, image: "/assets/ppf-film.png", images: ["/assets/ppf-film.png", "/assets/hero-auto.png", "/assets/sgcb-tools-banner-ru.jpg"], stock: 5, description: "Прозрачная полиуретановая плёнка с самовосстанавливающимся верхним слоем для защиты кузова от сколов и царапин.", specs: [["Ширина", "1,52 м"], ["Длина", "15 м"], ["Толщина", "190 мкм"], ["Гарантия", "7 лет"]] },
];
...
const articles = [
  ...
  { type: "NEWS", slug: "detailing-training-vladimir", title: "Практический день для детейлеров во Владимире", description: "Демонстрации полировки, ухода за интерьером и установки PPF на реальном автомобиле.", heroImage: "/assets/sgcb-tools-banner-ru.jpg", product: "polishing-machine", body: "Живые демонстрации\nТехнологи покажут полный цикл подготовки поверхности и подбора связки пасты с кругом.\n\nОтветы экспертов\nУчастники смогут разобрать рабочие ситуации и протестировать оборудование SGCB.\n\nРегистрация\nКоличество мест ограничено — следите за обновлениями в разделе новостей и Telegram." },
];
